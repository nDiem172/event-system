...
export default function RefundRequestsPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      await managerAPI.approveRefund(
        modal.refund._id,
        Number(amount)
      );
  ...
  return (
    <div>
      ...
      >
        💰 Yêu cầu hoàn tiền ({refunds.length})
      </h2>
          ...
          {refunds.map((r) => (
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                >
                  🎫 Loại:{' '}
                  {r.ticketId?.ticketType}
                  {' — '}Giá:{' '}
                  {r.ticketId?.price?.toLocaleString(
                    'vi-VN'
                  )}{' '}
                  đ
                </p>
            ...
            'approve' ? (
              <>
                ...
                >
                  ...
                  kiến:{' '}
                  <strong>
                    {modal.refund.expectedAmount?.toLocaleString(
                      'vi-VN'
                    )}{' '}
                    đ
                  </strong>
                ...
                >
                  ⚠️ Vui lòng thực hiện
                  hoàn tiền thực tế qua
                  VNPay trước khi bấm
                  xác nhận.
                </p>
